...
ket_c1 =(one_sqrt2)*np.array([0,0,-1j,1j])
ket_c2 =(one_sqrt2)*np.array([0,0,1j,-1j])
...
def output(ket):
    ...
    if np.array_equiv(np.round(ket,error),np.round(ket_c1,error)) or np.array_equiv(np.round(ket,error)
                                                                    ,np.round(ket_c2,error)):
        return 'constant'
    if np.array_equiv(np.round(ket,error),np.round(ket_b,error)) or np.array_equiv(np.round(ket,error)
                                                                    ,np.round(-ket_b,error)):
        return 'balance'
